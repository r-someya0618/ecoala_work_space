<!-- Quick Haire Dryer Productページ コンセプトパート -->
    ...
    <div class="p-product-concept__container l-container">
      ...
      <div class="p-product-concept__img-container">
        <div class="p-product-concept__img p-product-concept__img--left">
          <picture class="pc">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_1_pc.webp" type="image/webp">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_1_pc.png" alt="" />
          </picture>
          <picture class="sp">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_1_sp.webp" type="image/webp">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_1_sp.png" alt="" />
          </picture>
        </div>
      </div>
    </div>
    ...
    <div class="p-product-concept__container p-product-concept__container--reverse l-container">
      ...
      <div class="p-product-concept__img-container p-product-concept__img-container--reverse">
        <div class="p-product-concept__img p-product-concept__img--right">
          <picture class="pc">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_2_pc.webp" type="image/webp">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_2_pc.png" alt="" />
          </picture>
          <picture class="sp">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_2_sp.webp" type="image/webp">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product/concept/dryer/concept_2_sp.png" alt="" />
          </picture>
        </div>
      </div>
    </div>
