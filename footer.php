...
wp_enqueue_script('jquery','/wp-content/themes/ecoala/assets/js/jquery.min.js');
...
// wp_enqueue_script('iscroll','/wp-content/themes/ecoala/assets/js/iscroll.js',array('jquery'));
// wp_enqueue_script('drawer','/wp-content/themes/ecoala/assets/js/drawer.js',array('jquery'));
wp_enqueue_script('slick','/wp-content/themes/ecoala/assets/js/slick.min.js',array('jquery'));
// wp_enqueue_script('script','/wp-content/themes/ecoala/assets/js/common.js',array('jquery'));
