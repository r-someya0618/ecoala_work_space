...
<main>
  <section class="c-slider">
    <ul class="slider full">
      <li><img class="pc" src="<?php bloginfo('template_url'); ?>/assets/images/slide1.png" alt="" /><img class="sp" src="<?php bloginfo('template_url'); ?>/assets/images/slide1_sp.png" alt="" /></li>
      <li><img class="pc" src="<?php bloginfo('template_url'); ?>/assets/images/slide2.png" alt="" /><img class="sp" src="<?php bloginfo('template_url'); ?>/assets/images/slide2_sp.png" alt="" /></li>
      <li><img class="pc" src="<?php bloginfo('template_url'); ?>/assets/images/slide3.png" alt="" /><img class="sp" src="<?php bloginfo('template_url'); ?>/assets/images/slide3_sp.png" alt="" /></li>
      <li><img class="pc" src="<?php bloginfo('template_url'); ?>/assets/images/slide4.png" alt="" /><img class="sp" src="<?php bloginfo('template_url'); ?>/assets/images/slide4_sp.png" alt="" /></li>
    </ul>
  </section>
    ...
    <section class="p-top-feature-section l-container l-container--wide">
      <div class="p-top-feature-section__card">
        ...
        <dl class="p-top-feature-section__card-body">
          <dt class="p-top-feature-section__card-title c-text--30">
            高性能・高機能<br>
            プロ推奨ドライヤー
          </dt>
          <dd class="p-top-feature-section__card-text c-text--20">
    ...
    <div class="p-top-topics__posts-list">
      <dl class="p-top-topics__posts-list-item c-posts-list-card">
        ...
        <dt class="p-top-topics__posts-list-title c-posts-list-card__title">
          記事タイトルダミー記事タイトルダミー記事タイトルダミー記事タイトルダミー
        </dt>
      </dl>
      <dl class="p-top-topics__posts-list-item c-posts-list-card">
        <dd class="c-posts-list__thumbnail">
